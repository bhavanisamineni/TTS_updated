...
###################################################################################################################
###################################################################################################################
train_data= "C:\Users\CSE RGUKT\Downloads\TTS\TTS\TTS_zeroshot\data\raw_train_all_onecol.csv"
...
do
    echo "start randon seed ${seed}......"
  rm "C:\Users\CSE RGUKT\Downloads\TTS\TTS\TTS_zeroshot\data\raw_train_all_subset_kg_epoch_onecol.csv"
  cp "C:\Users\CSE RGUKT\Downloads\TTS\TTS\TTS_zeroshot\data\raw_train_all_subset_kg_epoch_led_onecol.csv" "C:\Users\CSE RGUKT\Downloads\TTS\TTS\TTS_zeroshot\data\raw_train_all_subset_kg_epoch_onecol.csv"
  for epoch in {0..1}
  do
      echo "start training Gen ${epoch}......"
      python "C:\Users\CSE RGUKT\Downloads\TTS\TTS\TTS_zeroshot\src\train_model.py" -c  "C:\Users\CSE RGUKT\Downloads\TTS\TTS\TTS_zeroshot\config\config-bert.txt" $1 -train ${train_data} -dev ${dev_data} -test ${test_data} -kg ${kg_data} \
